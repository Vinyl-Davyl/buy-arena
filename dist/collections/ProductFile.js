...
var yourOwnAndPurchased = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var user, products, ownProductFiledIds, orders, purchaseProductFileIds;
    var req = _b.req;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                ownProductFiledIds = products.map(function (prod) { return prod.product_files; }).flat();
                return [4 /*yield*/, req.payload.find({
                        collection: "orders",
            ...
            case 2:
                ...
                return [2 /*return*/, {
                        id: {
                            in: __spreadArray(__spreadArray([], ownProductFiledIds, true), purchaseProductFileIds, true),
                        },
                    }];
        }
    });
